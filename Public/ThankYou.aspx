<%@ Page Title="EosHealth - Thank You" Language="C#" MasterPageFile="~/MasterPages/User.master" AutoEventWireup="true" CodeFile="ThankYou.aspx.cs" Inherits="Public_ThankYou" ValidateRequest="true" %>
...
-->    
    ...
    <br /><br />
    <div align="center">
		<h1 class="warning"><font color="red">The payment processor has not been<br /> integrated yet. The order is being created automatically without the actual transaction.</font></h1>		
    </div>            
    </div>
</div>   
</div>         
