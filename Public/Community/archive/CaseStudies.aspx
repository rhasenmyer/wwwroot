                	...
                	<li class="no_bg">
                    	<div class="clearfix">
                            ...
                            <div class="text">
                                ...
                                <p class="bottom">
                                    <asp:LinkButton ID="lbtnView" runat="server" CommandArgument='<%# DataBinder.Eval(Container.DataItem, DBLayer.MedicalExperience.ColumnName.ID) %>' CommandName="view">Read More >  <%# DataBinder.Eval(Container.DataItem, DBLayer.MedicalExperience.ColumnName.ID) %></asp:LinkButton>                                                
                                </p>
                             </div>
						</div>   
